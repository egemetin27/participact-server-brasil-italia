...
public class GcmSender {
	...
	public static final String API_KEY = "AIzaSyAGHmaTa_RXnIYFpHaR0kI1JYht_VZXaJ4";

	public static void sender(String message, String regId) throws JSONException {
		try {
			JSONObject jGcmData = new JSONObject();
			JSONObject jData = new JSONObject();
			jData.put("title", "ParticipAct");
			jData.put("text", message);
