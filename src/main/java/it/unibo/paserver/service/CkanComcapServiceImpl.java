...
import it.unibo.paserver.repository.CkanComcapRepository;

@Service
@Transactional(readOnly = true)
public class CkanComcapServiceImpl implements CkanComcapService {

	@Autowired
	CkanComcapRepository repos;
	...
	@Override
	@Transactional(readOnly = true, propagation = Propagation.SUPPORTS)
	public List<CkanComcap> filter(ListMultimap<String, Object> params, String sortField, boolean ascending, PageRequest pagerequest) {
