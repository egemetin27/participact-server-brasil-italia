...
<div class="navbar navbar-inverse navbar-fixed-top">
	<div class="navbar-inner">
		<div class="container">
			...
			<a class="brand" href='<c:url value="/protected/dashboard"/>'>ParticipAct</a>
			<div class="nav-collapse collapse">
				<ul class="nav">
					<c:choose>
						<c:when test="${sectionKey eq 'index'}">
							<li class="active"><a href='<c:url value="/protected/dashboard"/>'>Home</a></li>
						</c:when>
						<c:otherwise>
					...
					<sec:authorize access="isAuthenticated()">
						...
						<li><a href='<c:url value="/protected/blank"/>'>Blank Page</a></li>
					</sec:authorize>
					<sec:authorize access="isAuthenticated() == false">
						<c:choose>
							<c:when test="${sectionKey eq 'login'}"><li class="active"><a href='<c:url value="/login"/>'>Login</a></li></c:when>
