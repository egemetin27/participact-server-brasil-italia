...
<div class="col-md-12">
	<div class="portlet">
	<!-- BREADCRUMB -->
	<jsp:include page="/WEB-INF/views/protected/campaign-task-area-activation/breadcrumb.jsp" />
	<!-- BEGIN FORM -->
	<div class="portlet-body form">
		...
		<div class="form-group">
			<label class="col-md-offset-2 col-md-7"><spring:message code="activation.area.help.message" text="Draw activation area" /></label>
