...
<div tabindex="-1" class="modal fade in" id="fullACTIVITY_RECOGNITION_COMPARE" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-full">
		<div class="modal-content">
			...
			<input type="hidden" id="HeyACTIVITY_RECOGNITION_COMPARE" value="0"/>
