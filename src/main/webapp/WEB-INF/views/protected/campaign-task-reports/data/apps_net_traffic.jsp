...
<div tabindex="-1" class="modal fade in" id="fullAPPS_NET_TRAFFIC" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-full">
		<div class="modal-content">
			...
			<input type="hidden" id="HeyAPPS_NET_TRAFFIC" value="0"/>
				...
				<table class="table table-striped table-bordered table-hover table-condensed" id="<%UUID.randomUUID().toString();%>">
					<thead>
						<tr role="row" class="heading">
							...
							<th class="col-md-3 text-center">Rx bytes</th>
							<th class="col-md-3 text-center">Tx bytes</th>
						</tr>
					</thead>
					<tbody>
