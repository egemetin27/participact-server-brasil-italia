...
<div tabindex="-1" class="modal fade in" id="fullCONNECTION_TYPE" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-full">
		<div class="modal-content">
			...
			<input type="hidden" id="HeyCONNECTION_TYPE" value="0"/>
				...
				<table class="table table-striped table-bordered table-hover table-condensed" id="<%UUID.randomUUID().toString();%>">
					<thead>
						<tr role="row" class="heading">
							...
							<th class="text-center">Mobile Network Type</th>
						</tr>
					</thead>
					<tbody>
