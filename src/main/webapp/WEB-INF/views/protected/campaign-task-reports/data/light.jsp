...
<div tabindex="-1" class="modal fade in" id="fullLIGHT" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-full">
		<div class="modal-content">
			...
			<input type="hidden" id="HeyLIGHT" value="0"/>
			<div class="table-scrollable">
				<table class="table table-striped table-bordered table-hover table-condensed" id="<%UUID.randomUUID().toString();%>">
					<thead>
						<tr role="row" class="heading">
							<th>#</th>
							<th class="col-md-2"><spring:message code="username.title" text="User" /></th>
							<th class="col-md-3 text-center"><spring:message code="timestamp.title" text="Timestamp" /></th>
							<th class="col-md-3 text-center"><spring:message code="value.title" text="Value" /></th>
						</tr>
					</thead>
					<tbody>
