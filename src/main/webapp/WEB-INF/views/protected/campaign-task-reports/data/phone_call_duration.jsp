...
<div tabindex="-1" class="modal fade in" id="fullPHONE_CALL_DURATION" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-full">
		<div class="modal-content">
			...
			<input type="hidden" id="HeyPHONE_CALL_DURATION" value="0"/>
				...
				<table class="table table-striped table-bordered table-hover table-condensed" id="<%UUID.randomUUID().toString();%>">
					<thead>
						<tr role="row" class="heading">
							...
							<th class="col-md-3 text-center"><spring:message code="callstart.title" text="Call Start" /></th>
							<th class="col-md-3 text-center"><spring:message code="callend.title" text="Call End" /></th>
							<th class="col-md-3 text-center"><spring:message code="isincoming.title" text="Is Incoming" /></th>
							<th class="col-md-3 text-center"><spring:message code="phonenumber.title" text="Phonenumber" /></th>
						</tr>
					</thead>
					<tbody>
						<tr ng-repeat="(key_data, item_data) in records" id="records-tr-{{item[0]}}">
							...
							<td class="text-center">{{item_data[4].millis | date:'dd/MM/yyyy HH:mm:ss'}}</td>
							<td class="text-center">{{item_data[5].millis | date:'dd/MM/yyyy HH:mm:ss'}}</td>
							<td class="text-center">
								<small ng-show="item_data[6]"><spring:message code="yes.title" text="Yes" /></small>
								<small ng-hide="item_data[6]"><spring:message code="no.title" text="No" /></small>
							</td>
