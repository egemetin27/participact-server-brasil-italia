...
<div tabindex="-1" class="modal fade in" id="fullPHONE_CALL_EVENT" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-full">
		<div class="modal-content">
			...
			<input type="hidden" id="HeyPHONE_CALL_EVENT" value="0"/>
				...
				<table class="table table-striped table-bordered table-hover table-condensed" id="<%UUID.randomUUID().toString();%>">
					<thead>
						<tr role="row" class="heading">
							...
							<th class="col-md-3 text-center"><spring:message code="isincoming.title" text="Is Incoming Call" /></th>
							<th class="col-md-3 text-center"><spring:message code="isstart.title" text="Is Start" /></th>
					...
					<tbody>
						<tr ng-repeat="(key_data, item_data) in records" id="records-tr-{{item[0]}}">
							...
							<td class="text-center">
								<small ng-show="item_data[4]"><spring:message code="yes.title" text="Yes" /></small>
								<small ng-hide="item_data[4]"><spring:message code="no.title" text="No" /></small>							
							</td>
							<td class="text-center">
								<small ng-show="item_data[5]"><spring:message code="yes.title" text="Yes" /></small>
								<small ng-hide="item_data[5]"><spring:message code="no.title" text="No" /></small>							
							</td>
