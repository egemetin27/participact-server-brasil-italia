...
<div tabindex="-1" class="modal fade in" id="fullTEST" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-full">
		<div class="modal-content">
			...
			<input type="hidden" id="HeyTEST" value="0"/>
				...
				<table class="table table-striped table-bordered table-hover table-condensed" id="<%UUID.randomUUID().toString();%>">
					<thead>
						<tr role="row" class="heading">
							...
							<th class="col-md-3 text-center">X</th>
							<th class="col-md-3 text-center">Y</th>
							<th class="col-md-3 text-center">Z</th>
						</tr>
					</thead>
					<tbody>
						<tr ng-repeat="(key_data, item_data) in records" id="records-tr-{{item[0]}}">
							<td>{{item_data[0]}}</td>
							<td>{{item_data[2]}}&nbsp;{{item_data[3]}}</td>
