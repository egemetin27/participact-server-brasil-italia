...
<!-- BEGIN PAGE-->
<div class="row" ng-controller="FeedbackTypeCtrl" ng-init="initFeedbackType();" ng-cloak>
<div class="col-md-12">
		<div class="portlet">
		<!-- BREADCRUMB -->
		...
		<div class="pull-right">
			<form class="form-inline" role="form">
				...
				<div class="form-group"><button title="<spring:message code="search.title" text="Search" />" class="btn blue btn-sm" type="button" ng-click="initFeedbackType();"><i class="fa fa-search"></i></button></div>
			</form>
			</div>
		</div></div>	
		</div>		
		...
		<div class="portlet-body" ng-show="feedbacks.length > '0'">
			<div class="table-scrollable">
				<table class="table table-striped table-bordered table-hover table-checkable" id="<%UUID.randomUUID().toString();%>">
					...
					<tbody>
						<tr ng-repeat="item in feedbacks" id="feedbacks-tr-{{item[0]}}">
							...
							<td ng-click="editFeedbackType(item[0]);" class="qz-pointer">{{item[1] | stripslashes}}</td>
						</tr>
					</tbody>
				</table>
			</div>
