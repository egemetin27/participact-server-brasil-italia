   ...
   <section>
	...
	<div class="form-group">
		<div class="input-group">
			...
			<div ng-show="filter.input=='FILTER_TASKID_RUNNING'||filter.input=='FILTER_TASKID'"><jsp:include page="/WEB-INF/templates/partial/selectCampaign.jsp" /></div>
...
<!-- HELPS -->
<div ng-show="filter.input=='FILTER_TASKID_RUNNING'||filter.input=='FILTER_TASKID'">
<div class="row"><div class="col-md-12"><div class="pull-right">
	<p><small class="help-block"><spring:message code="help.select.campaign" text="To search for a Campaign, type a few words in the search box, and click the plus button" /></small></p>
</div></div></div>	
</div>
<!-- TAGS --> 
