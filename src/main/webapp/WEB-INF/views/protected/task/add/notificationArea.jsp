...
<link rel="stylesheet" href="<c:url value="/resources/1.0/js/leaflet/leaflet.css" />">
<link rel="stylesheet" href="<c:url value="/resources/1.0/js/leafletdraw/leaflet.draw.css"/>" />
<script src="<c:url value="/resources/1.0/js/leaflet/leaflet.js"/>"></script>
<script src="<c:url value="/resources/1.0/js/leafletdraw/leaflet.draw.js"/>"></script>
<script src="<c:url value="/resources/1.0/js/OpenLayers.js"/>"></script>
<script src="<c:url value="/resources/1.0/js/participact/gis.js"/>"></script>
<script>        

$(document).ready(function() {
	var map = L.map('map').setView([-27.5927817, -48.5429635], 13);
