...
<body>
	...
	<div class="portlet-title">
		<div class="caption">
		<span class="caption-subject font-green sbold uppercase"><spring:message code="edi.title" text="Edit Device" /></span>
		</div>
	</div>
	<div class="container">
		<div class="row">
			<div class="span3 bs-docs-sidebar">
				<jsp:include page="/WEB-INF/templates/userdeviceSidenav.jsp">
					<jsp:param value="protected.userdevice.edit" name="subsection" />
				</jsp:include>
			</div>
			<div class="span9">
				<div class="page-header">
					<h3>Edit User Device</h3>
				</div>
				...
				<spring:url value="/protected/userdevice/edit/${userDeviceId}" var="editUserDeviceForm"></spring:url>
				<form:form method="POST" modelAttribute="editUserDeviceForm" action="${editUserDeviceForm}" enctype="multipart/form-data">
					<fieldset>
						<div class="span9">
						...
						<div class="span2">
							...
							<a class="btn btn-danger" type="submit" href='<c:url value="/protected/userdevice"/>'>Cancel</a>
						</div>
					</fieldset>
				</form:form>
			</div>
